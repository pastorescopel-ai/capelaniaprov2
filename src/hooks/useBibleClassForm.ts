  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result && typeof result === 'object' && 'success' in result && !result.success) {
          // persistent:true -- erro precisa ficar na tela até alguém ler/fechar, não sumir em
          // 4s sozinho, pra dar tempo do usuário mostrar pro master ou anotar o que apareceu.
