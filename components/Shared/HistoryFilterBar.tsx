        ...
        {isAdmin && (
          <div className="flex-1 w-full space-y-1">
            ...
            <select 
              ...
              className="w-full p-3 bg-slate-50 border-none rounded-xl font-bold text-xs text-slate-700 outline-none focus:ring-2 focus:ring-blue-500/20 transition-all"
            >
